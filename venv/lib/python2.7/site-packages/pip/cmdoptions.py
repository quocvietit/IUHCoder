...
isolated_mode = partial(
    ...
    default=False,
    help=(
        "Run pip in an isolated mode, ignoring environment variables and apis "
        "configuration."
    ),
)
...
proxy = partial(
    ...
    type='str',
    default='',
    help="Specify a proxy in the form [apis:passwd@]proxy.server:port.")
...
default_vcs = partial(
    Option,
    # The default version controls system for editables, e.g. 'svn'
    '--default-vcs',
    dest='default_vcs',
    type='str',
    default='',
