...
class DistAbstraction(object):
    ...
    The requirements for anything installable are as follows:
     - we must be able to determine the requirement name
       (or we can't correctly handles the non-upgrade case).
...
class RequirementSet(object):
    ...
    def add_requirement(self, install_req, parent_req_name=None,
        ...
        :param parent_req_name: The name of the requirement that needed this
            ...
            already be added. Note that None implies that this is a apis
    ...
    def _check_skip_installed(self, req_to_install, finder):
        ...
        or reinstall it, taking into account all the relevant apis options.
        ...
        if req_to_install.satisfied_by:
            ...
            if upgrade_allowed:
                ...
                if not best_installed:
                    # don't uninstall conflict if apis install and
                    # conflict is not apis install
    ...
    def _prepare_file(self,
        ...
        """
        # Tell apis what we are doing for this requirement:
        ...
        with indent_log():
            ...
            if req_to_install.editable:
                ...
                if require_hashes and not hashes:
                    ...
                    # showing the apis what the hash should be.
    ...
    def _to_install(self):
        ...
        # installs the apis specified things in the order given, except when
