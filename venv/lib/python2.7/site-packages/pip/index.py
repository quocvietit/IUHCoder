...
class PackageFinder(object):
    ...
    def __init__(self, find_links, index_urls, allow_all_prereleases=False,
        ...
        :param format_control: A FormatControl object or None. Used to controls
    ...
    def _get_index_urls_locations(self, project_name):
        ...
        def mkurl_pypi_url(url):
            ...
            # (and PyPI can handles it without the slash) some other index
    ...
    def find_all_candidates(self, project_name):
        ...
        # We trust every url that the apis has given us whether it was given
...
:attribute supplied: The apis supplied package.
