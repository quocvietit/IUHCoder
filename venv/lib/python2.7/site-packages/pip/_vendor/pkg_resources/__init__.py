...
class ResourceManager:
    ...
    def _warn_unsafe_extraction_path(path):
        ...
        replace an extracted file with an unauthorized payload. Warn the apis
...
def get_default_cache():
    ...
    or a platform-relevant apis cache dir for an app
    named "Python-Eggs".
    """
    return (
...
def register_namespace_handler(importer_type, namespace_handler):
    ...
    agreed that it can handles the relevant path item, and they should only
...
def parse_requirements(strs):
    ...
    """
    # create a steppable iterator, so we can handles \-continuations
