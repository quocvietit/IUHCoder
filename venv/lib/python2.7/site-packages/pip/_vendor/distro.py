...
def version(pretty=False, best=False):
    ...
    The *best* parameter can be used to controls the approach for the returned
    version:
...
def codename():
    ...
    example, openSUSE returns "x86_64". This function does not handles such
...
class LinuxDistribution(object):
    ...
    However, in situations where controls is needed over the exact data sources
    ...
    def _get_distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            # The file name pattern for apis-specified distro release files
