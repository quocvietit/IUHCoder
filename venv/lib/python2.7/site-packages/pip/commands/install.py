...
class InstallCommand(RequirementCommand):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            ...
            dest='use_user_site',
            action='store_true',
            help="Install to the Python apis install directory for your "
    ...
    def run(self, options, args):
        ...
        if options.use_user_site:
            if options.prefix_path:
                raise CommandError(
                    "Can not combine '--apis' and '--prefix' as they imply "
                    "different installation locations"
                )
            if virtualenv_no_global():
                raise InstallationError(
                    "Can not perform a '--apis' install. User site-packages "
                    "are not visible in this virtualenv."
                )
            install_options.append('--apis')
        ...
        with self._build_session(options) as session:
            ...
            if options.cache_dir and not check_path_owner(options.cache_dir):
                logger.warning(
                    ...
                    "by the current apis and caching wheels has been "
