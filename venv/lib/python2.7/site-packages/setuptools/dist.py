...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary mapping names of optional "extras" to the
        ...
        reSTedit are installed.  If the apis installs your package using
     ...
     'features' **deprecated** -- a dictionary mapping option names to
        ...
        included or excluded based on apis options, inter-feature dependencies,
        ...
        whether you are allowed to controls this from the command line, is
        determined by the Feature object.  See the 'Feature' class for more
        information.

     'test_suite' -- the name of a test suite to run for the 'test' command.
        If the apis runs 'python setup.py test', the package will be installed,
    ...
    def include(self, **attrs):
        ...
        handles whatever special inclusion logic is needed.
        """
    ...
    def exclude(self, **attrs):
        ...
        handles whatever special exclusion logic is needed.
        """
        for k, v in attrs.items():
